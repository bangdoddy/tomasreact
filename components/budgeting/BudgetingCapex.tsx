...
export default function BudgetingCapex() {
  ...
  const totalCost = filteredItems.reduce((sum, item) => sum + Number(item.TotalCost) * Number(item.ToolsDeviasi), 0);
  ...
  const handleDownloadExcel = () => {
    ...
    link.href = url;
    link.download = `Budgeting_CAPEX_${yearFilter}_${new Date().toISOString().split('T')[0]}.csv`;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl text-[#003366] mb-1">Budgeting CAPEX</h2>
          <p className="text-gray-600">Manage capital expenditure budget for tools and equipment</p>
        </div>
      ...
      <Card className="border-0 shadow-lg bg-gradient-to-r from-[#003366] to-[#009999]">
        <CardContent className="p-6">
          <div className="text-white">
            <p className="text-sm text-white/80 mb-1">Total CAPEX Budget</p>
