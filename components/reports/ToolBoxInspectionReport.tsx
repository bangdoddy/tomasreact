...
export default function ToolBoxInspectionReport() {
  ...
  const stats = { total: 98, passed: 89, failed: 6, pending: 3 };
            ...
            <Table>
              ...
              <TableBody>
                <TableRow className="hover:bg-gray-50">
                  <TableCell className="text-[#009999]">TB-INS-001</TableCell>
                  <TableCell>TB-A-001</TableCell>
                ...
                <TableRow className="hover:bg-gray-50">
                  <TableCell className="text-[#009999]">TB-INS-002</TableCell>
                  <TableCell>TB-B-002</TableCell>
