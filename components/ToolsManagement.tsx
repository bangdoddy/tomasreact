    ...
    reader.onload = async (event) => {
      try {
        ...
        const importedTools = jsonData.map((row) => ({
          ...
          ToolsIdEll: row['toolsIdEll'] || row['ToolsIdEll'] || '',
          ...
          ToolsSatusCapex: row['StatusCapex'] || row['StatusCapex'] || 'n',
          ToolsCategory: row['ToolsCategory'] || row['ToolsCategory'] || '',
          ToolsGroupType: row['ToolsGroupType'] || row['ToolsGroupType'] || '',
          ...
          ToolsWeight: row['ToolsWeight'] || row['toolsWeight'] || '',
        }));
