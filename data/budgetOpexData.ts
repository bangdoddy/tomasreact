export interface BudgetOpexItem {
  id: string;
  toolsId: string;
...
export const initialBudgetOpexData: BudgetOpexItem[] = [
  {
    id: '1',
    toolsId: 'CDMSA',
...
export const getBudgetCategories = (items: BudgetOpexItem[]) => {
...
export const getRecentRequests = (items: BudgetOpexItem[], limit: number = 4) => {
  return items
